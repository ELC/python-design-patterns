...
def main():
    ...
    turn_on = partial(turn_on_command, receiver=heating_system)
    set_24_degrees = partial(set_temperature_command, receiver=heating_system, target_temperature=24)
    set_26_degrees = partial(set_temperature_command, receiver=heating_system, target_temperature=26)
