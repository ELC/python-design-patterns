...
from patterns.behavioural.strategy.solution_02 import (
    CustomerSupport,
...
def test_fifo_ordering_strategy(
    ...
    ordered = fifo_ordering_strategy.create_ordering(support_tickets)
...
def test_filo_ordering_strategy(
    ...
    ordered = filo_ordering_strategy.create_ordering(support_tickets)
...
def test_random_ordering_strategy_with_seed(
    ...
    ordered = random_ordering_strategy.create_ordering(support_tickets)
...
def test_random_ordering_strategy_without_seed(
    ...
    ordered = random_ordering_strategy_no_seed.create_ordering(support_tickets)
