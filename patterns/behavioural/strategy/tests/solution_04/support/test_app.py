...
from patterns.behavioural.strategy.solution_04 import (
    CustomerSupport,
    SupportTicket,
...
def test_random_strategy_generator_with_seed(
    support_tickets: list[SupportTicket],
    expected_random_tickets: list[SupportTicket],
) -> None:
    ordered = random_strategy_generator(seed=5)(support_tickets)

    assert ordered == expected_random_tickets


def test_random_strategy_generator_without_seed(
    support_tickets: list[SupportTicket],
    expected_unseeded_random_tickets: list[SupportTicket],
) -> None:
    ordered = random_strategy_generator()(support_tickets)
